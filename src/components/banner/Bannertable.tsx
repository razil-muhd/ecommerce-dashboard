  ...
  return (
    <div className="rounded-[10px] border border-stroke bg-white p-4 shadow-1 dark:border-dark-3 dark:bg-gray-dark dark:shadow-card sm:p-7.5">
      <div className="max-w-full overflow-x-auto">
       <div className="flex justify-between pb-2"> <h1 className="text-white">Banner</h1>
       <Link className="text-white" href={"/admin/banners/add"}>Add Banner</Link></div>
          ...
          <tbody>
            {banners.map((banneritem:any, index:number)  => (
              <tr key={index}>
                ...
                <td
                  className={`border-[#eee] px-4 py-4 dark:border-dark-3 xl:pr-7.5 ${index === banneritem.length - 1 ? "border-b-0" : "border-b"}`}
                >
